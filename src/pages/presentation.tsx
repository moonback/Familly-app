...
const PresentationPage = () => {
  ...
  const features = [
    {
      ...
      description: "Créez et suivez les tâches quotidiennes de vos enfants avec un système de récompenses motivant"
    },
    {
      icon: "⭐",
      title: "Système de récompenses",
      description: "Motivez vos enfants avec un système de points et de récompenses personnalisables"
    },
    {
      icon: "📊",
      title: "Suivi des progrès",
      description: "Visualisez les progrès de vos enfants dans leurs différentes activités et responsabilités"
    },
    {
      icon: "👨‍👩‍👧‍👦",
      title: "Interface adaptée",
      description: "Une interface simple et ludique pour les enfants, complète et intuitive pour les parents"
    },
    {
      icon: "📱",
      title: "Application mobile",
      description: "Accédez à Family App depuis n'importe quel appareil, partout et à tout moment"
    },
    {
      icon: "🔔",
      title: "Notifications",
      description: "Restez informé des activités et des progrès de vos enfants en temps réel"
    }
  ];
  ...
  const testimonials = [
    {
      text: "Family App a transformé notre quotidien ! Les enfants sont plus motivés et autonomes.",
      author: "Sophie, maman de 3 enfants",
      rating: 5
    },
    {
      text: "Une application intuitive qui rend la gestion familiale plus agréable et efficace.",
      author: "Thomas, papa de 2 enfants",
      rating: 5
    },
    {
      text: "Les enfants adorent gagner des points et les parents apprécient le suivi des tâches.",
  ...
  const faqs = [
    {
      ...
      answer: "Les parents peuvent définir des points pour chaque tâche accomplie. Les enfants accumulent ces points et peuvent les échanger contre des récompenses définies par les parents."
    },
    {
      question: "Est-ce que l'application est gratuite ?",
      answer: "Family App propose une version gratuite avec les fonctionnalités de base. Une version premium est disponible avec des fonctionnalités avancées."
    },
    {
      question: "Comment protéger la vie privée de ma famille ?",
      answer: "Nous prenons la sécurité très au sérieux. Toutes les données sont cryptées et nous respectons strictement le RGPD."
    },
    {
      question: "Puis-je utiliser l'application sur plusieurs appareils ?",
      answer: "Oui, Family App est disponible sur tous les appareils (ordinateur, tablette, smartphone) et synchronise automatiquement les données."
    }
  ];
